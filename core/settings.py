...
SECRET_KEY = 'django-insecure-+f6s^g))7_^*&-v1$)9j6f()v*f*864gw33!5h4u9ud=l=1%$l'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sheryan_db',
        'USER': 'sheryan_user',
        'PASSWORD': 'sheryan_secure_pass',
        'HOST': os.environ.get('DB_HOST', 'db'),  # اسم الخدمة (service name) المكتوب في docker-compose.yml
        'PORT': '5432',
    }
}
